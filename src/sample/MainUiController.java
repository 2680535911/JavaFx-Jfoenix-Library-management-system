...
public class MainUiController implements Initializable {
    ...
    @FXML
    public TableColumn tb_column_book_stock;
    ...
    @FXML
    private JFXButton btn_jieshu_clear;//清除按钮
    ...
    @FXML
    private JFXButton btn_ts_add_book_clear;//清除按钮
    ...
    @FXML
    private JFXButton btn_ts_alter_book_clearBtn;//清除按钮
    @FXML
    ...
    @FXML
    private JFXButton btn_ts_delete_book_clearBtn;//清除按钮
    @FXML
    ...
    @FXML
    private JFXButton btn_rd_add_reader_clearBtn;//清除按钮
    ...
    @FXML
    private JFXButton btn_rd_alter_reader_clearBtn;//清除按钮
    ...
    @FXML
    private JFXButton btn_rd_delete_reader_clearBtn;//清除按钮
    @FXML
    ...
    public void setMyName(String myName) {
        ...
        if (user != null) {
            lb_welcome.setText(user.getName()+" ,您好！");
        }
    }
...
//        initBooksUi();
        ...
        tb_column_book_stock.setCellValueFactory(new PropertyValueFactory("stock"));
...
//        tb_column_reader_borrowed_books.setCellValueFactory(new PropertyValueFactory("borrowed_books"));
    ...
    public void js_confirm_start() {
        if (!tf_js_book_id.getText().equals("") && !tf_js_reader_id.getText().equals("")) {
            ...
            if (isBorrow) {
                ...
                alert.setContentText("借书失败！请检查输入的书籍 ID 和读者 ID 是否正确，或者该书籍已被借阅。");
                alert.setTitle("借书失败！");
                alert.show();
            }
        } else {
    ...
    private void huanshu_start() {
        if (!tf_hs_reader_id.getText().trim().equals("")) {
