...
//        prgs_login.setVisible(false);
    ...
    public void forgotPass() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/resources/forgotPass.fxml"));
        Parent root = null;
        try {
            root = loader.load();
        } catch (IOException e) {
    ...
    public void logUp() {
        ...
        myLogupStage.getIcons().add(new Image(
                Main.class.getResourceAsStream("/sample/image/logo.png")));
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/resources/user_logUp.fxml"));
        Parent root = null;
        try {
            root = loader.load();
        } catch (IOException e) {
   ...
   class myProgress implements Runnable {
        ...
        public void run() {
            try {
                ...
                sleep(100);
                //更新JavaFX的主线程的代码放在此处
                Platform.runLater(sample.Controller.this::doCheckUser);
